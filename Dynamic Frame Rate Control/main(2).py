...
model = YOLO(r"C:\Users\theekshana\Desktop\Kidzcare adult kid detection models\94.1 63.3\best (4).pt")  

video_path = r"C:\Users\theekshana\Downloads\3327104-hd_1280_720_24fps.mp4"  # Replace with your video file path
...
while True:
    ...
    if motion_detected(prev_frame, img):
        fps = high_fps  # Increase frame rate
        print("Motion detected. Increasing frame rate.")
    else:
